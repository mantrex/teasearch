...
namespace Drupal\Tests\choices\Functional;
 ...
 * @group choices
 */
class ChoicesFunctionalTest extends BrowserTestBase {
  ...
  public function testUninstallation() {
    // Go to uninstallation page an uninstall choices:
    $session = $this->assertSession();
    $page = $this->getSession()->getPage();
    $this->drupalGet('/admin/modules/uninstall');
    $session->statusCodeEquals(200);
    $page->checkField('edit-uninstall-choices');
